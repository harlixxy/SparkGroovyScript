...
task {
    ...
    def maintaining_stop_metrics = [whStop, diYpwh, diKzgJt, diJcJt, diTjJt]
    ...
    mp = rule1(mp, stop != null && stop.value == 1D, maintaining_stop_metrics, [16, 17, 18, 19, 20])
    ...
    def time_items = [ fengsu , fengxang ,  cangwWd ,  yeYali ,stop ,  running , start , commErr , mStop , fail ,
                       qStop , eStop , weaStop , gridErr , whStop , diYpwh ,
                       diKzgJt , diTjJt , diJcJt , alarm ]
    def getTime = { items ->
