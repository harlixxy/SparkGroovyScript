...
task {
    ...
    def limit_load_stop_metrics = [ppmStop, diDdxfhtj]
    ...
    mp = rule1(mp, stop != null && stop.value == 1D, limit_load_stop_metrics, [14, 15])
    ...
    def time_items = [fengsu, fengxang, cangwWd, yeYali,
                      stop,running,start,commErr, mStop, fail, qStop, eStop, weaStop, gridErr,
                      whStop, diYpwh, diKzgJt, diTjJt, diJcJt, ppmStop, diDdxfhtj, alarm, ppmFd]
    def getTime = { items ->
